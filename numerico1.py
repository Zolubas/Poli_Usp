...
plt.suptitle('Exemplo Item 1A - Erro Absoluto')
plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
plt.xlabel('Comprimento da Barra (m)')
plt.ylabel('Temperatura (ºC)')
plt.grid()
...
plt.plot(xi, u[:, M], color = 'blue', label = 'Solução Numérica')
plt.plot(xi, u_real, color = 'red', label = 'Solução Real')
plt.suptitle('Entregável Item 1A - Numérica x Real')
plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
plt.xlabel('Comprimento da Barra (m)')
plt.ylabel('Temperatura (ºC)')
plt.grid()
...
plt.suptitle('Entregável Item 1A - Erro Absoluto')
plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
plt.xlabel('Comprimento da Barra (m)')
plt.ylabel('Temperatura (ºC)')
plt.grid()
...
# -- Gráifco x vs u
plt.plot(xi, u[:, M], color = 'blue', label = 'Solução Numérica')
plt.suptitle('Entregável Item 1C - Gráifco x vs u')
plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
...
for v in range(len(p_igual_x)):
    ...
    plt.suptitle('Entregável Item 1C - Gráifco t vs u')
    plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
...
legenda = plt.colorbar(mapa)
legenda.set_label('Temperatura (ºC)', rotation=270)
plt.suptitle('Entregável Item 1C - Mapa de Calor - Umin = ' + str(np.amin(u)) + "; Umax = " + str(np.amax(u)))
plt.title('N = {}, M = {}, Lambda = {}.'.format(N, M, λ))
plt.xlabel('Tempo (t) no intervalo [0,T], T = 1  ')
plt.ylabel('Posição (X) na barra no intervalo [0,1]')
plt.grid()
